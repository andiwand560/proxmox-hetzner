...
if [ -f /etc/apt/sources.list.d/pve-enterprise.list ]; then
  echo -e "#deb https://enterprise.proxmox.com/debian bookworm pve-enterprise\\n" > /etc/apt/sources.list.d/pve-enterprise.list
fi
...
if [ ! -f /etc/apt/sources.list.d/proxmox.list ] && [ ! -f /etc/apt/sources.list.d/pve-public-repo.list ] && [ ! -f /etc/apt/sources.list.d/pve-install-repo.list ] ; then
  echo -e "deb http://download.proxmox.com/debian bookworm pve-no-subscription\\n" > /etc/apt/sources.list.d/pve-public-repo.list
fi
...
# echo "deb http://download.proxmox.com/debian/ceph-luminous bookworm main" > /etc/apt/sources.list.d/ceph.list
