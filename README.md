...
````
wget https://raw.githubusercontent.com/andiwand560/proxmox-hetzner/master/install-hetzner-sata.sh -c -O install-hetzner.sh && chmod +x install-hetzner.sh
./install-hetzner.sh "PVE Hostname"
````

## For server with NVME Disk
````
wget https://raw.githubusercontent.com/andiwand560/proxmox-hetzner/master/install-hetzner-nvme.sh -c -O install-hetzner.sh && chmod +x install-hetzner.sh
./install-hetzner.sh "PVE Hostname"
````
* Reboot
...
## LVM to ZFS
````
wget https://raw.githubusercontent.com/andiwand560/proxmox-hetzner/master/lvm-2-zfs.sh -c -O lvm-2-zfs.sh  && chmod +x lvm-2-zfs.sh
...
```
wget https://raw.githubusercontent.com/andiwand560/proxmox-hetzner/master/createzfs.sh -c -O createzfs.sh && chmod +x createzfs.sh
...
```
wget https://raw.githubusercontent.com/andiwand560/proxmox-hetzner/master/xshok_slog_cache-2-zfs.sh -c -O xshok_slog_cache-2-zfs.sh && chmod +x xshok_slog_cache-2-zfs.sh
...
```
curl https://raw.githubusercontent.com/andiwand560/proxmox-hetzner/master/pve-enable-lxc-docker.sh --output /usr/sbin/pve-enable-lxc-docker && chmod +x /usr/sbin/pve-enable-lxc-docker
...
```
wget https://raw.githubusercontent.com/andiwand560/proxmox-hetzner/master/network-configure.sh -c -O network-configure.sh && chmod +x network-configure.sh
...
```
wget https://raw.githubusercontent.com/andiwand560/proxmox-hetzner/master/network-addiprange.sh -c -O network-addiprange.sh && chmod +x network-addiprange.sh
